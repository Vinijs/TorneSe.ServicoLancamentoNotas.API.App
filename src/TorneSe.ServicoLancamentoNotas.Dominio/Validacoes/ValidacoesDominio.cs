...
public static class ValidacoesDominio
{
    ...
    public static void NumeroMaximoCaracteres(string texto, int numeroMaximoCaracteres, string nomeCampo, NotifiableObject objetoNotificavel, string nomeCampo2, string mensagem)
    {
