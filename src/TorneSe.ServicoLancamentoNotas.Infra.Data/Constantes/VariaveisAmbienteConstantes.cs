namespace TorneSe.ServicoLancamentoNotas.Infra.Data.Constantes;

public static class VariaveisAmbienteConstantes
{ 
    public const string TENANTS = "TENANTS";
    public const string SEPARADOR_TENANTS = ";";
    public const string CONNECTION_STRING_PREFIX = "CONNECTION_STRING_";
    public const string URL_BASE_CURSOS = "URL_BASE_CURSOS";
    public const string PATH_OBTER_CURSOS = "PATH_OBTER_CURSOS";
    ...
    public const string ELASTIC_SEARCH_URL = "ELASTIC_SEARCH_URL";
