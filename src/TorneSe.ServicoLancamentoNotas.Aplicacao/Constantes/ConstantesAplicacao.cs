namespace TorneSe.ServicoLancamentoNotas.Aplicacao.Constantes;
...
public static class ConstantesAplicacao
{
    public static class MensagensErro 
    {
        ...
        public const string INPUT_NOTA_INVALIDO = "Alguma(s) das informação(ões) de entrada estão inválida(s)";
        public const string NAO_FOI_POSSIVEL_VALIDAR_VINCULOS_CURSO = "Não foi possivel validar vinculos para o curso";
    }
