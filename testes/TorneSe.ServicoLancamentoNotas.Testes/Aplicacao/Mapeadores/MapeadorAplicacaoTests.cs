...
public class MapeadorAplicacaoTests
{
    ...
    [Fact(DisplayName = nameof(NotaEmNotaOutputModel_QuandoConvertido_DeveRetornarNota))]
    [Trait("Aplicacao", "Mapeadores - NotaOutputModel")]
    public void NotaEmNotaOutputModel_QuandoConvertido_DeveRetornarNota()
    {
        //Assert
        var nota = _fixture.RetornaNotaValida();

        //Act
        var outputModel = MapeadorAplicacao.NotaEmNotaOutputModel(nota);
