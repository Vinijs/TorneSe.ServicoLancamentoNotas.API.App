...
public class NotaTestes
{
    ...
    [Theory(DisplayName = nameof(AlterarStatusIntegracaoParaEnviada_QuandoNaoPermitidoTrocaStatus_DeveAdicionarNotificacao))]
    ...
    [Trait("Dominio", "Nota - Agregado")]
    public void AlterarStatusIntegracaoParaEnviada_QuandoNaoPermitidoTrocaStatus_DeveAdicionarNotificacao(StatusIntegracao statusIntegracao)
    {
        //Arrange
    ...
    public void AlterarStatusIntegracaoParaIntegradaComSucesso_QuandoPermitidoTrocaStatus_DeveAtualizarOStatus()
    {
        ...
        //Act
        nota.AlterarStatusIntegracaoParaComSucesso();
