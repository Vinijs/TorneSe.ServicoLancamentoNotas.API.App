...
namespace TorneSe.ServicoLancamentoNotas.TestesIntegracao.Aplicacao.CasosDeUso.Nota.Cancelar;
...
public class CancelarNotaTests
{
    ...
    public async Task Handle_QuandoCancelarInput_DeveCancelarNota()
    {
        ...
        var notaSalva = await _context.Notas.FirstOrDefaultAsync(x => x.AlunoId == nota.AlunoId &&
                                                                 x.AtividadeId == nota.AtividadeId);
